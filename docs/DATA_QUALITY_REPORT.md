...
- 单日收盘价绝对变化超过 50%；
- 财务公告日期缺失。
- 当前证券的上游 ExpireDate 命中实机确认的五个哨兵值
  `10001011/10001111/10011011/10011111/10111111` 时，不解释为真实退市日；Processed
  `delist_date` 置空并标记 `INVALID_SENTINEL_IGNORED`，Raw/实机证据保留。其他早于上市日
  的日期不会被吞掉，仍触发 `listing_interval` ERROR。
